...
subroutine gronor_gntwo(lfndbg)
  ...
  integer :: lfndbg,i,ii,jj,k,l,n,kl,intg,nrow,idx_j
...
!$acc end parallel
        ...
        istat = cublasDdot(cublas_handle, int(nrow, c_int), gmat, int(1, c_int), &
                            pmat, int(1, c_int), dotres)
