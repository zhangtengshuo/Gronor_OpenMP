...
!  real (kind=8), allocatable :: work(:)
  ...
  integer (kind=4) :: len4_work_dbl,len4_work2_dbl,len4_work_int
...
module amd_rocsolver
  use iso_c_binding
      ...
      module rocsolver_interfaces_enums
       implicit none
      ...
      end module rocsolver_interfaces_enums
      module rocsolver_interfaces
      ...
      end module rocsolver_interfaces
